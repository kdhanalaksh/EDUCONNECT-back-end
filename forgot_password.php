...
$stmt = $conn->prepare("UPDATE user SET otp = ?, otp_created_at = ? WHERE email = ?");
...
if ($stmt->execute() && $stmt->affected_rows > 0) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'kdhanalakshmi2005@gmail.com';       // ✅ Replace with your Gmail
        $mail->Password   = 'stth lhvp egwr ycfv';          // ✅ Replace with your App Password
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;
